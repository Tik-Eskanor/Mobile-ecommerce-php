               ...
               <a href="product.php?item_id=<?php echo $item['item_id']?>"><img src="<?php echo $item["item_image"] ?? 'images/banner1.png'?>" class="p-2 img"></a>
                 ...
                 <form method="post">
                  ...
                  <?php
                     ...
                     {
                      echo '<button type="submit" disabled name="new_phone_submit" class="btn btn-success">in cart</button>';
                     }
                     else 
                     {
                       echo '<button type="submit" name="new_phone_submit" class="btn btn-warning">Add to cart</button>';
                     }
                  ?>
                 </form>
                 </div>
